...
//!
//! This consumes the Stage-1 safetensors produced by inference-flame's
//! `scripts/qwenimage_edit_encode.py`:
//!
...
#[derive(Parser)]
struct Args {
    /// Stage-1 Qwen Edit embeddings safetensors from qwenimage_edit_encode.py.
    #[arg(
        long,
        default_value = "/home/alex/EriDiffusion/inference-flame/output/qwenimage_edit_embeds.safetensors"
    )]
    embeds: PathBuf,
